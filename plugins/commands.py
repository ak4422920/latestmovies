...
async def donation(bot, message):
    ...
    yt=await message.reply_photo(photo='https://envs.sh/a_.jpg', caption=script.DONATE_TXT, reply_markup=InlineKeyboardMarkup(btn))
    await asyncio.sleep(300)
    await yt.delete()
